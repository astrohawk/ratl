...
protected:
    ...
    TransformNoninterleavedBase()
    {
        ...
        {
            super_type::buffer_.data()[i] =
                reference_convert<input_sample>(Sample<OutputSampleType>{i + 1}).get();
        }
    }
...
TYPED_TEST(TransformNoninterleaved, Typical)
{
    ...
    for (size_t channel_num = 0; channel_num < input_buffer.channels(); ++channel_num)
    {
        ...
        {
            EXPECT_EQ(
                reference_convert<typename TestFixture::input_sample>(output_buffer[channel_num][frame_num]),
...
TYPED_TEST(TransformFrame, Typical)
{
    ...
    {
        EXPECT_EQ(
            reference_convert<typename TestFixture::input_sample>(output_frame[channel_num]), input_frame[channel_num]);
    }
...
TYPED_TEST(TransformChannel, Typical)
{
    ...
    {
        EXPECT_EQ(
            reference_convert<typename TestFixture::input_sample>(output_channel[sample_num]),
...
TYPED_TEST(TransformNoninterleavedSingleFrame, Typical)
{
    ...
    {
        EXPECT_EQ(
            reference_convert<typename TestFixture::input_sample>(output_buffer[channel_num][0]),
...
TYPED_TEST(TransformChannelSingleFrame, Typical)
{
    ...
    // verify all samples have been copied correctly
    EXPECT_EQ(reference_convert<typename TestFixture::input_sample>(output_channel[0]), input_channel[0]);
...
TYPED_TEST(TransformNoninterleavedSingleChannel, Typical)
{
    ...
    {
        EXPECT_EQ(
            reference_convert<typename TestFixture::input_sample>(output_buffer[0][frame_num]),
...
TYPED_TEST(TransformFrameSingleChannel, Typical)
{
    ...
    EXPECT_EQ(reference_convert<typename TestFixture::input_sample>(output_frame[0]), input_frame[0]);
