...
private:
    ...
    using OutputSampleValueType = typename OutputSample::value_type;
...
public:
    ...
    inline OutputSampleValueType operator()(const InputSampleValueType& input) const noexcept
    {
    ...
    {
        return OutputSample{
            static_cast<OutputSampleValueType>(SampleConverter::convert(input.get(), dither_generator_))};
    }
