...
inline xsimd::batch<std::int32_t, 8> batch_round_float32_to_int32(const xsimd::batch<float, 8>& input)
{
...
inline xsimd::batch<std::int32_t, 16> batch_round_float32_to_int32(const xsimd::batch<float, 16>& input)
{
