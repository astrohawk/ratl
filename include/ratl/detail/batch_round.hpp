...
inline xsimd::batch<int32_t, 4> batchRoundFloat32ToInt32(const xsimd::batch<float, 4>& input)
{
...
inline xsimd::batch<int32_t, 8> batchRoundFloat32ToInt32(const xsimd::batch<float, 8>& input)
{
...
inline xsimd::batch<int32_t, 16> batchRoundFloat32ToInt32(const xsimd::batch<float, 16>& input)
{
